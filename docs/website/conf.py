...
BLOG_AUTHOR = "Antoine Falaize"  # (translatable)
BLOG_TITLE = "PyPHS Handbook"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://pythonhosted.org/pyphs/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://pythonhosted.org/pyphs/"
BLOG_EMAIL = "antoine.falaize@gmail.com"
BLOG_DESCRIPTION = "This site gathers the documentations and the tutorials related to the python package PyPHS."  # (translatable)
...
POSTS = (
    ("posts/*.rst", "tutos", "post.tmpl"),
    ("posts/*.txt", "tutos", "post.tmpl"),
    ("posts/*.ipynb", "tutos", "post.tmpl"),	
)
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; 2012-{date}         <a href="mailto:{email}">{author}</a> - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
...
NAVIGATION_LINKS = {
    ...
    (
        (
        	(
        		('http://www.cecill.info/licences/Licence_CeCILL-B_V1-en.html', 'Read the license'),
        		('https://github.com/A-Falaize/pyphs', 'Get from Github'),
        		('https://pypi.python.org/pypi/pyphs', 'Get from pyPI')
        	), 'Get PyPHS'
        ),
        (
