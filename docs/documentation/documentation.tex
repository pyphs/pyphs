...
%
This class implements the PHS structure (\ref{eq:PHS}) and several manipulation methods.
%
\begin{python}
import pyphs

# instantiate the Port-Hamiltonian object:
core = pyphs.PHSCore(label='mylabel')
\end{python}
%
