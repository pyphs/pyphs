...
class Damper(DissipativeLinear):
    def __init__(self, label, nodes, **kwargs):
        ...
        if parameters["A"] is None:
            ...
            coeff = parameters["A"]
        DissipativeLinear.__init__(self, label, nodes, coeff=coeff, inv_coeff=False)
    ...
    metadata = {
        ...
        "label": "damp",
        "dico": "mechanics_dual",
        "desc": r"Linear mechanical damping (i.e. opposing force proportional to the velocity). In Laplace domain with :math:`s\in\mathbb C`:"
        + equation(r"e(s) = A \, f(s)."),
        "nodesdesc": "Nodes associated with the component terminals with positive flux N1->N2.",
        "nodes": ("N1", "N2"),
        "parametersdesc": "Component parameter",
        "parameters": [["A", "Damping coefficient", "N.s/m", 1.0]],
        "refs": {},
        "nnodes": 2,
        "nedges": 1,
