...
class Bjt(DissipativeNonLinear):
    def __init__(self, label, nodes, **kwargs):
        ...
        coeffs = types.matrix_types[0](
            [[(betaR + 1) / betaR, -1], [-1, (betaF + 1) / betaF]]
        )
        funcs = [
            Is * (sympy.exp(wbjt[0] / (mu * Vt)) - 1) + GMIN * wbjt[0],
        ...
        DissipativeNonLinear.__init__(
            self, label, edges, wbjt + wR, list(zbjt) + list(zR), **parameters
        )
    ...
    metadata = {
        ...
        "parameters": [
            ...
            [
                "betaF",
                "Forward common emitter current gain in [20, 500]",
                "d.u.",
                200.0,
            ],
