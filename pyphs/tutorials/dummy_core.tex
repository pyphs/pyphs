...
\\
%
Hamiltonian gradient $ \nabla \mathtt{H}(\mathbf{x}) = \left(\begin{array}{c}\frac{x_{\mathrm{L}}}{L}\\\frac{Cnl \cdot x_{\mathrm{C}}^{3}}{2 \cdot C} + \frac{2}{C} \cdot x_{\mathrm{C}} \cdot \left(\frac{Cnl}{4} \cdot x_{\mathrm{C}}^{2} + 0.5\right)\end{array}\right) ; $ 
%
\\
%
%
