...
class Springsat(StorageNonLinear):
    ...
    metadata = {
        "title": "Saturating spring",
        "component": "Springsat",
        "label": "spring",
        "dico": "mechanics",
        "desc": (
            r"Saturating spring from [1]_ (chap 7) with state :math:`q\in [-q_{sat}, q_{sat}]` and parameters described below. The energy is"
            + equation(
        ...
        "parameters": [
            ["K0", "Stiffness around zero", "H", 1e3],
