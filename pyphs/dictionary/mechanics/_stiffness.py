...
class Stiffness(StorageLinear):
    def __init__(self, label, nodes, **kwargs):
        ...
        kwargs = {"name": par_name, "value": par_val, "inv_coeff": False, "ctrl": "e"}
    ...
    metadata = {
        ...
        "label": "stiff",
        "dico": "mechanics",
        "desc": r"Linear stiffness between two points in a 1D space. In Laplace domain with :math:`s\in\mathbb C`:"
        + equation(r"f(s) = \frac{K\,e(s)}{s}."),
