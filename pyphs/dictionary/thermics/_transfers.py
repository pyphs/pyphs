...
class Transfer(DissipativeNonLinear):
    def __init__(self, label, nodes, **kwargs):
        ...
        # init component
        DissipativeNonLinear.__init__(
            self, label, [edge1, edge2], w, [z1, z2], **kwargs
        )
    ...
    metadata = {
        ...
        "dico": "thermics",
        "desc": (
            r"Irreversible heat transfer between two thermal nodes. It is made from two dissipative edges. The dissipation variables are temperatures (:math:`w_1=T_1` and :math:`w_2=T_2`). The dissipation functions are:"
            + equation(
                r"\begin{array}{rcl} \dot \sigma _1 = z_1(w_1, w_2) & = & R\frac{w_1-w_2}{w_1}, \\ \dot \sigma _2 = z_2(w_1, w_2) & = & R\frac{w_2-w_1}{w_2}.  \end{array}"
            )
        ),
