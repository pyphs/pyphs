...
class Potentiometer(DissipativeNonLinear):
    def __init__(self, label, nodes, **kwargs):
        ...
        # init component
        DissipativeNonLinear.__init__(self, label, [edge_1, edge_2], w, z, **parameters)
