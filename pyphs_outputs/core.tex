...
%
$ \mathbf{M} = \left(\begin{array}{ccc}- Rnl \cdot \left(x_{\mathrm{L}}^{2} + 1\right) & -1 & -1\\1 & 0 & 0\\1 & 0 & 0\end{array}\right) ; $ 
%
\\
%
$ \mathbf{M_{xx}} = \left(\begin{array}{cc}- Rnl \cdot \left(x_{\mathrm{L}}^{2} + 1\right) & -1\\1 & 0\end{array}\right) ; $ 
%
\\
%
...
%
$ \mathbf{R} = \left(\begin{array}{ccc}1.0 \cdot Rnl \cdot \left(x_{\mathrm{L}}^{2} + 1\right) & 0 & 0\\0 & 0 & 0\\0 & 0 & 0\end{array}\right) ; $ 
%
\\
%
$ \mathbf{R_{xx}} = \left(\begin{array}{cc}1.0 \cdot Rnl \cdot \left(x_{\mathrm{L}}^{2} + 1\right) & 0\\0 & 0\end{array}\right) ; $ 
%
\\
%
